...
HD_PWD='C:/Users/kunal/barrel_shift_register_behab/barrel_shift_register_behab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log barrel_shift_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source barrel_shift_tb.tcl -notrace

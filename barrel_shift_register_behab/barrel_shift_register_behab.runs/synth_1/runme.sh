...
HD_PWD='C:/Users/kunal/barrel_shift_register_behab/barrel_shift_register_behab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log barrel_shift_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source barrel_shift_tb.tcl
